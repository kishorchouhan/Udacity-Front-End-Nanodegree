...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var myRandomPizzas = document.querySelectorAll(".randomPizzaContainer");
    for (var i = 0; i < myRandomPizzas.length; i++) {
      //var dx = determineDx(myRandomPizzas[i], size);
      //var newwidth = (myRandomPizzas[i].offsetWidth + dx) + 'px';
      myRandomPizzas[i].style.width = newwidth + '%';
    }
  }
